...
- Do not start V8 during V7 reconciliation, final audit, Junie audit, final
  validation, Runtime Pack evolution, workflow evolution, or freeze gates.
- Do not merge, push, tag, or freeze without explicit HITL authorization.
