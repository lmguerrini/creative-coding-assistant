...
from creative_coding_assistant.orchestration.agent_lifecycle import AgentLifecycleRegistry, agent_lifecycle_registry
from creative_coding_assistant.orchestration.agent_metadata import AgentMetadataRegistry, agent_metadata_registry
