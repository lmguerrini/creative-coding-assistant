...
_TASTE_EVOLUTION_ENGINE = (
    "creative_coding_assistant.orchestration.taste_evolution_engine"
)
...
_EXPORT_MAP = {
    ...
    "StrategyLearningPattern": _STRATEGY_LEARNING,
    ...
    "ProductionDeploymentPlan": _PRODUCTION_DEPLOYMENT,
    ...
    "SelfImprovementProposalsPlan": _SELF_IMPROVEMENT_PROPOSALS,
    "SelfImprovementProposalsProposal": _SELF_IMPROVEMENT_PROPOSALS,
    "build_self_improvement_proposals": _SELF_IMPROVEMENT_PROPOSALS,
    ...
    "taste_evolution_engine_proposal_by_id": _TASTE_EVOLUTION_ENGINE,
    "taste_evolution_engine_proposals_for_confidence": _TASTE_EVOLUTION_ENGINE,
    "taste_evolution_engine_proposals_for_status": _TASTE_EVOLUTION_ENGINE,
    "ReasoningEvolutionEnginePlan": _REASONING_EVOLUTION_ENGINE,
    "ReasoningEvolutionEngineProposal": _REASONING_EVOLUTION_ENGINE,
    "build_reasoning_evolution_engine": _REASONING_EVOLUTION_ENGINE,
    "reasoning_evolution_engine_proposal_by_id": _REASONING_EVOLUTION_ENGINE,
    ...
    "UnifiedMemoryGraphEdge": _UNIFIED_MEMORY_GRAPH,
    "UnifiedMemoryGraphNode": _UNIFIED_MEMORY_GRAPH,
    "UnifiedMemoryGraphPlan": _UNIFIED_MEMORY_GRAPH,
    "build_unified_memory_graph": _UNIFIED_MEMORY_GRAPH,
    ...
    "UnifiedCapabilityRegistryEntry": _UNIFIED_CAPABILITY_REGISTRY,
    "UnifiedCapabilityRegistryPlan": _UNIFIED_CAPABILITY_REGISTRY,
    "build_unified_capability_registry": _UNIFIED_CAPABILITY_REGISTRY,
    ...
    "CrossSystemOptimizationLayerPlan": _CROSS_SYSTEM_OPTIMIZATION_LAYER,
    "CrossSystemOptimizationSignal": _CROSS_SYSTEM_OPTIMIZATION_LAYER,
    "build_cross_system_optimization_layer": _CROSS_SYSTEM_OPTIMIZATION_LAYER,
    ...
    "CognitiveProfile": _COGNITIVE_PROFILE_ENGINE,
    "CognitiveProfileEnginePlan": _COGNITIVE_PROFILE_ENGINE,
    "build_cognitive_profile_engine": _COGNITIVE_PROFILE_ENGINE,
    "cognitive_profile_by_id": _COGNITIVE_PROFILE_ENGINE,
    "cognitive_profiles_for_agent": _COGNITIVE_PROFILE_ENGINE,
    "cognitive_profiles_for_layer": _COGNITIVE_PROFILE_ENGINE,
    "MetaReasoningAssessment": _META_REASONING_LAYER,
    "MetaReasoningLayerPlan": _META_REASONING_LAYER,
    "build_meta_reasoning_layer": _META_REASONING_LAYER,
    ...
    "CognitiveGovernanceLayerPlan": _COGNITIVE_GOVERNANCE_LAYER,
    "CognitiveGovernancePolicy": _COGNITIVE_GOVERNANCE_LAYER,
    "build_cognitive_governance_layer": _COGNITIVE_GOVERNANCE_LAYER,
    ...
    "CreativeIdentityLayerPlan": _CREATIVE_IDENTITY_LAYER,
    "CreativeIdentityProfile": _CREATIVE_IDENTITY_LAYER,
    "build_creative_identity_layer": _CREATIVE_IDENTITY_LAYER,
    ...
    "CognitiveSchedulerPlan": _COGNITIVE_SCHEDULER,
    "CognitiveScheduleSlot": _COGNITIVE_SCHEDULER,
    "build_cognitive_scheduler": _COGNITIVE_SCHEDULER,
    "cognitive_schedule_slot_by_id": _COGNITIVE_SCHEDULER,
    ...
    "CognitiveExplanationEnginePlan": _COGNITIVE_EXPLANATION_ENGINE,
    "CognitiveExplanationTrace": _COGNITIVE_EXPLANATION_ENGINE,
    "build_cognitive_explanation_engine": _COGNITIVE_EXPLANATION_ENGINE,
    "cognitive_explanation_trace_by_id": _COGNITIVE_EXPLANATION_ENGINE,
    "cognitive_explanation_traces_for_agent": _COGNITIVE_EXPLANATION_ENGINE,
    "cognitive_explanation_traces_for_layer": _COGNITIVE_EXPLANATION_ENGINE,
    "cognitive_explanation_traces_for_posture": _COGNITIVE_EXPLANATION_ENGINE,
    "CognitiveSafetyBoundary": _COGNITIVE_SAFETY_LAYER,
    "CognitiveSafetyLayerPlan": _COGNITIVE_SAFETY_LAYER,
    "build_cognitive_safety_layer": _COGNITIVE_SAFETY_LAYER,
    "cognitive_safety_boundaries_for_agent": _COGNITIVE_SAFETY_LAYER,
    ...
    "WebResearchPlan": _WEB_RESEARCH,
    "WebResearchEntry": _WEB_RESEARCH,
    "build_web_research": _WEB_RESEARCH,
    ...
    "ContradictionDetectionPlan": _CONTRADICTION_DETECTION,
    "ContradictionDetectionEntry": _CONTRADICTION_DETECTION,
    "build_contradiction_detection": _CONTRADICTION_DETECTION,
    ...
    "CreativeResearchPlan": _CREATIVE_RESEARCH_ENGINE,
    "CreativeResearchEntry": _CREATIVE_RESEARCH_ENGINE,
    "build_creative_research_engine": _CREATIVE_RESEARCH_ENGINE,
    ...
    "KnowledgeQualityScoringPlan": _KNOWLEDGE_QUALITY_SCORING,
    "KnowledgeQualitySignal": _KNOWLEDGE_QUALITY_SCORING,
    "build_knowledge_quality_scoring": _KNOWLEDGE_QUALITY_SCORING,
    ...
    "KnowledgeDriftDetectionPlan": _KNOWLEDGE_DRIFT_DETECTION,
    "KnowledgeDriftSignal": _KNOWLEDGE_DRIFT_DETECTION,
    "build_knowledge_drift_detection": _KNOWLEDGE_DRIFT_DETECTION,
    ...
    "KnowledgeProvenanceEvolutionPlan": _KNOWLEDGE_PROVENANCE_EVOLUTION,
    ...
    "knowledge_snapshot_signal_by_id": _KNOWLEDGE_SNAPSHOT_ENGINE,
    "knowledge_snapshot_signals_for_confidence": _KNOWLEDGE_SNAPSHOT_ENGINE,
    "knowledge_snapshot_signals_for_status": _KNOWLEDGE_SNAPSHOT_ENGINE,
    ...
    "build_style_profiles": _STYLE_PROFILES,
    ...
    "build_creative_dna": _CREATIVE_DNA,
    ...
    "build_creative_lineage": _CREATIVE_LINEAGE,
    ...
    "build_creative_memory_core_surface": _CREATIVE_MEMORY_CORE_SURFACE,
    "creative_memory_core_surface_entry_by_id": _CREATIVE_MEMORY_CORE_SURFACE,
    ...
    "learn_strategies": _STRATEGY_LEARNING,
    "strategy_learning_pattern_by_id": _STRATEGY_LEARNING,
    "strategy_learning_patterns_for_priority": _STRATEGY_LEARNING,
    "strategy_learning_patterns_for_status": _STRATEGY_LEARNING,
    "learn_techniques": _TECHNIQUE_LEARNING,
    ...
    "learn_routing": _ROUTING_LEARNING,
    ...
    "learn_evaluations": _EVALUATION_LEARNING,
    ...
    "build_production_deployment_plan": _PRODUCTION_DEPLOYMENT,
    "production_deployment_record_by_surface": _PRODUCTION_DEPLOYMENT,
    "production_deployment_records_for_status": _PRODUCTION_DEPLOYMENT,
    ...
    "build_production_architecture_freeze": _PRODUCTION_ARCHITECTURE_FREEZE,
