...
REQUIRED_RUNTIME_FILES = (
    ...
    "RUNTIME_LEDGER_INTEGRITY_FINAL_VERIFICATION.md",
    "FINAL_ARCHITECTURE_SNAPSHOT.md",
    "ENGINEERING_WORKFLOW_SNAPSHOT.md",
    "GENERATION_V7_CONTEXT_PACK.md",
    "RUNTIME_PACK_EVOLUTION_REPORT.md",
    "ENGINEERING_WORKFLOW_EVOLUTION_REPORT.md",
)
