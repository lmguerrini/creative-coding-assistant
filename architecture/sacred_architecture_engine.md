...
- `src/creative_coding_assistant/knowledge/sacred_architecture.py`
- `src/creative_coding_assistant/knowledge/sacred_architecture_contracts.py`
- `src/creative_coding_assistant/knowledge/sacred_architecture_catalog.py`
- `src/creative_coding_assistant/knowledge/sacred_architecture_guidance.py`

## Runtime Boundary

- The engine is local, deterministic, typed, and report-only.
- Pattern guidance includes architectural proportion, floor-plan reasoning,
...
- Sacred architecture pattern taxonomy for harmonic proportion plans, axis and
  ...
  gothic-inspired light axes, tessellated courtyard fields, labyrinth paths,
  chamber sequences, gallery installations, and pavilion environments.
- Floor-plan and planimetry guidance expressed as zones, paths, nodes, edges,
  ratios, thresholds, center/periphery roles, and viewer flow.
- Bounded reverse-engineering guidance from textual or spatial descriptions.
- Semantic topology nodes and edges for entry, threshold, axis, center,
