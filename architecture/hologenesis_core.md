...
- `src/creative_coding_assistant/knowledge/hologenesis_core.py`
- `src/creative_coding_assistant/knowledge/hologenesis_core_contracts.py`
- `src/creative_coding_assistant/knowledge/hologenesis_core_catalog.py`
- `src/creative_coding_assistant/knowledge/hologenesis_core_guidance.py`
...
- Unified Symbolic, Sacred Knowledge, Geometry, Narrative, and Installation
  graph projections.
- Report-only creative blackboard entries.
- Symbolic schedule and creative planner stages.
- Advisory creative routes that explicitly do not route providers or models.
- Explainable artistic decisions with graph provenance and confidence.
- Curatorial intelligence, reasoning, validation, explainability, mystical
...
| TouchDesigner | Export planning only |
| Blender | Export planning only |
...
- Museum readiness, international exhibition readiness, and installation
  quality are advisory review signals, not institutional, legal, safety, or
