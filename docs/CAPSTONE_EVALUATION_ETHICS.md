...
- Redacted latest-live RAGAs run:
  ...
  4 rows with zero skipped samples and zero metric failures. Averages:
  context precision `0.7006944444251505`, faithfulness `0.625`, and answer
  relevancy `0.46063699875040387`.
...
- Golden artifact QA: `demo/golden_artifacts/p5_sacred_geometry_sketch.js`,
